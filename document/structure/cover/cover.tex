...
%
\def\title{Seminar in Cloud Computing \\ IaaS Systems}
%
%
...
%
\def\name{Markus Hiesmair \\ J\"urgen Ratzenb\"ock \\ Christoph Stenglein}
%
%
...
%
\def\institute{Institute for Intelligent Information Systems}
%
%
...
%
\def\firstreferee{Univ.-Prof. Dr. Roland Wagner}
%
%
...
%
\begin{center}
\bigskip\bigskip\bigskip\bigskip\bigskip\par
{\LARGE\bfseries\title}
{\Large\ifcase\type DISSERTATION\or DIPLOMARBEIT\or MASTERARBEIT\or Seminar Thesis\fi}
\bigskip\par
\end{center}
%
% more space ???
%\bigskip
\bigskip\bigskip\bigskip\bigskip\bigskip\bigskip\bigskip\par
Submitted by:
\smallskip\par
{\large\name}
\medskip\bigskip\par
